...
//! Compact scene description for the LLM system prompt. Lives here (the deck
//! layer) so every deck consumer — the desktop app and the iOS FFI shell —
//! feeds the model the same, identically-sanitized digest.
